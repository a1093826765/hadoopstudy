...
//        job.setJar("/Users/november/IdeaProjects/hadoopstudy/out/artifacts/hadoopstudy_jar/hadoopstudy.jar");
        ...
        job.setReducerClass(InverIndexStepTwo.InverIndexStepTwoReduce.class);
        ...
        //指定job输入的原始文件目录
        FileInputFormat.setInputPaths(job,new Path("/Users/november/Desktop/file/test/out2/part-r-00000"));
        //指定job输出结果的所在目录
        FileOutputFormat.setOutputPath(job,new Path("/Users/november/Desktop/file/test/out3"));
